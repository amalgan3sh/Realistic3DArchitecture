...
<body>
  <header>
    ...
    <nav>
      <ul>
        <li><a href="<?php echo base_url('index.php/Onlinecontroller/adminManageDesigner'); ?>">Designer</a></li>
        <li><a href="<?php echo base_url('index.php/Onlinecontroller/adminManageArchitect'); ?>">Architect</a></li>
        <li><a href="<?php echo base_url('index.php/Onlinecontroller/adminManageCompany'); ?>">Company</a></li>

        <li><a href="<?php echo base_url('index.php/Onlinecontroller/adminManageproject'); ?>">project</a></li>
        <li><a href="<?php echo base_url('index.php/Onlinecontroller/adminLogOut'); ?>">Log out</a></li>
      </ul>
    </nav>
  </header>
  <main>
    ...
    <section>
      ...
      <ul>
        ...
        <li>New settings applied</li>
      </ul>
    </section>
  </main>
  <footer>
    <p>&copy; 2024 Realistic 3D Architecture. All rights reserved.</p>
  </footer>
...
-->
    ...
    <div class="col-md-6 col_4">
      ...
      <!----Calender -------->
      <link rel="stylesheet" href="<?php echo base_url('admin_assets/') ?>css/clndr.css" type="text/css" />
...
var detail = new Rickshaw.Graph.HoverDetail({
  graph: graph
        ...
        <!-- map -->
<link href="<?php echo base_url('admin_assets/') ?>css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="<?php echo base_url('admin_assets/') ?>js/jquery.vmap.js"></script>
<script src="<?php echo base_url('admin_assets/') ?>js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="<?php echo base_url('admin_assets/') ?>js/jquery.vmap.world.js" type="text/javascript"></script>
