...
<body>
  ...
  <div class="login-container" id="loginContainer">
    ...
    <form action="<?php echo base_url('index.php/Onlinecontroller/registerUser'); ?>" method="post">
    ...
    <div class="login-link">
      Already have an account? <a href="<?php echo base_url('index.php/Onlinecontroller/index'); ?>">Log In</a>
    </div>
  </div>
</body>
